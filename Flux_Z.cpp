...
#pragma omp parallel for private(k,temp)
	...
	for (i = istart; i <= iend; i++) {
		for (j = 2; j <= ny; j++) {
			...
			ML1[i-1][j-1][k] = temp*(2*U1_[i][j][nz-2]-13*U1_[i][j][k-1]+47*U1_[i][j][k]+27*U1_[i][j][k+1]-3*U1_[i][j][k+2]);
			ML2[i-1][j-1][k] = temp*(2*U2_[i][j][nz-2]-13*U2_[i][j][k-1]+47*U2_[i][j][k]+27*U2_[i][j][k+1]-3*U2_[i][j][k+2]);
			ML3[i-1][j-1][k] = temp*(2*U3_[i][j][nz-2]-13*U3_[i][j][k-1]+47*U3_[i][j][k]+27*U3_[i][j][k+1]-3*U3_[i][j][k+2]);
			ML4[i-1][j-1][k] = temp*(2*U4_[i][j][nz-2]-13*U4_[i][j][k-1]+47*U4_[i][j][k]+27*U4_[i][j][k+1]-3*U4_[i][j][k+2]);
			ML5[i-1][j-1][k] = temp*(2*U5_[i][j][nz-2]-13*U5_[i][j][k-1]+47*U5_[i][j][k]+27*U5_[i][j][k+1]-3*U5_[i][j][k+2]);
			...
			MR1[i-1][j-1][k] = temp*(-3*U1_[i][j][k-1]+27*U1_[i][j][k]+47*U1_[i][j][k+1]-13*U1_[i][j][k+2]+2*U1_[i][j][4]);
			MR2[i-1][j-1][k] = temp*(-3*U2_[i][j][k-1]+27*U2_[i][j][k]+47*U2_[i][j][k+1]-13*U2_[i][j][k+2]+2*U2_[i][j][4]);
			MR3[i-1][j-1][k] = temp*(-3*U3_[i][j][k-1]+27*U3_[i][j][k]+47*U3_[i][j][k+1]-13*U3_[i][j][k+2]+2*U3_[i][j][4]);
			MR4[i-1][j-1][k] = temp*(-3*U4_[i][j][k-1]+27*U4_[i][j][k]+47*U4_[i][j][k+1]-13*U4_[i][j][k+2]+2*U4_[i][j][4]);
			MR5[i-1][j-1][k] = temp*(-3*U5_[i][j][k-1]+27*U5_[i][j][k]+47*U5_[i][j][k+1]-13*U5_[i][j][k+2]+2*U5_[i][j][4]);
