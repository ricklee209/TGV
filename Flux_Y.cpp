...
#pragma omp parallel for private(k,temp)
	...
	for (i = istart; i <= iend; i++) {
		for (k = 2; k <= nz; k++) {
			...
			ML1[i-1][j][k-1] = temp*(2*U1_[i][ny-2][k]-13*U1_[i][j-1][k]+47*U1_[i][j][k]+27*U1_[i][j+1][k]-3*U1_[i][j+2][k]);
			ML2[i-1][j][k-1] = temp*(2*U2_[i][ny-2][k]-13*U2_[i][j-1][k]+47*U2_[i][j][k]+27*U2_[i][j+1][k]-3*U2_[i][j+2][k]);
			ML3[i-1][j][k-1] = temp*(2*U3_[i][ny-2][k]-13*U3_[i][j-1][k]+47*U3_[i][j][k]+27*U3_[i][j+1][k]-3*U3_[i][j+2][k]);
			ML4[i-1][j][k-1] = temp*(2*U4_[i][ny-2][k]-13*U4_[i][j-1][k]+47*U4_[i][j][k]+27*U4_[i][j+1][k]-3*U4_[i][j+2][k]);
			ML5[i-1][j][k-1] = temp*(2*U5_[i][ny-2][k]-13*U5_[i][j-1][k]+47*U5_[i][j][k]+27*U5_[i][j+1][k]-3*U5_[i][j+2][k]);
			...
			MR1[i-1][j][k-1] = temp*(-3*U1_[i][j-1][k]+27*U1_[i][j][k]+47*U1_[i][j+1][k]-13*U1_[i][j+2][k]+2*U1_[i][4][k]);
			MR2[i-1][j][k-1] = temp*(-3*U2_[i][j-1][k]+27*U2_[i][j][k]+47*U2_[i][j+1][k]-13*U2_[i][j+2][k]+2*U2_[i][4][k]);
			MR3[i-1][j][k-1] = temp*(-3*U3_[i][j-1][k]+27*U3_[i][j][k]+47*U3_[i][j+1][k]-13*U3_[i][j+2][k]+2*U3_[i][4][k]);
			MR4[i-1][j][k-1] = temp*(-3*U4_[i][j-1][k]+27*U4_[i][j][k]+47*U4_[i][j+1][k]-13*U4_[i][j+2][k]+2*U4_[i][4][k]);
			MR5[i-1][j][k-1] = temp*(-3*U5_[i][j-1][k]+27*U5_[i][j][k]+47*U5_[i][j+1][k]-13*U5_[i][j+2][k]+2*U5_[i][4][k]);
